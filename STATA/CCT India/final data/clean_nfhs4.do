/*==============================================================================
     Clean NFHS 4- Children Recode data 
...
*log
log using "$dir\logs\clean_nfhs4.log", replace

*Import NFHS 5- Children Recode data
use "$dir\data\dhs 2015-2016\Children's recode\IAKR74DT\IAKR74FL.DTA", replace
...
*ren b19 age_month 
	*label var age_month "Age in months"
...
gen ch_bw=m19
	...
	*replace ch_bw=r(p1) if ch_bw<=r(p1)	& (ch_bw~=9996 & ch_bw~=9998 & ch_bw~=.)
	label var ch_bw "Birth weight in grams"
...
recode m18 (5=1 "Very small") (4=2 "Smaller than average") (1/3=3 "Average or larger") (8/9=9 "Don't know/missing"), gen(ch_birth_size)
	...
	label var ch_birth_size "Size of the child at birth as reported by mother"
...
/* Hep-B at birth
gen ch_hepb=.
	replace ch_hepb=1 if inlist(hep0, 1, 2, 3) 
	replace ch_hepb=0 if hep0 == 0
...
* Hep-B1
gen ch_hep1=.
	replace ch_hep1=1 if inlist(hep1, 1, 2, 3) 
	replace ch_hep1=0 if hep1 == 0
...
* Hep-B1
gen ch_hep1=.
	replace ch_hep1=1 if (inlist(hep0, 1, 2, 3) | inlist(hep1, 1, 2, 3))
	replace ch_hep1=0 if (hep0==0 & hep1==0)
	label var ch_hep1	"Received Hepatitis-B1"
...
* Hep-B2
gen ch_hep2= .
	replace ch_hep2=1 if inlist(hep2, 1, 2, 3) 
	replace ch_hep2=0 if hep2 == 0
	label var ch_hep2	"Received Hepatitis-B2"
		
* Hep-B3
gen ch_hep3 = .
	replace ch_hep3=1 if inlist(hep3, 1, 2, 3) 
	replace ch_hep3=0 if hep3 == 0
...
recode hw70 (9996/9998=.), gen(height_age)		
...
* Weight-for-age z-score	
	recode hw71 (9996/9998=.), gen(weight_age)
...
save "$dir\data\output\inter_nfhs4\nfhs4.dta", replace
